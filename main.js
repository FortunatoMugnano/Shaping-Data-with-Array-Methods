...
console.log("NY Business Only", newYorkBusinesses)


const nyDom = document.querySelector("#newYork")
nyDom.innerHTML = "<h1>New York Business</h1>"

const nyHTML = (businesses) => {
...
nyHTML(newYorkBusinesses)




// Array to contain all the Manufacturing business
...
console.log("Manufacturing companies only", manufacturingBusiness)


let manDom = document.querySelector("#manufacturing")
manDom.innerHTML = "<h1> Manufacturing Companies</h1>"

const manHtml = (businesses) => {
    businesses.forEach(businesses => {
        manDom.innerHTML += `
      <h2>${businesses.companyName}</h2>
    <section>
